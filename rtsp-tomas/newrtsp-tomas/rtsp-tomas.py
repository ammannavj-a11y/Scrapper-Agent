...
def process_reports(rtsp_file, tranlog_file, output_base):
    # Load RTSP data
    ...
    out_df.to_csv(csv_output_file, index=False)
    ...
    print(f"Excel output written to {excel_output_file}")

# Usage
if __name__ == "__main__":
    process_reports("rtsp_report.csv", "tranlog_report.csv", "comparison_output")
